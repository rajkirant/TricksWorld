...
function setBackground(){
	...
	if(d.getHours()<6 || d.getHours()>20)
		document.body.style.backgroundImage = "url('static/images/background3.jpg')";
	else if (d.getHours()<17)
		document.body.style.backgroundImage = "url('static/images/background1.jpg')";
	else
		document.body.style.backgroundImage = "url('static/images/background2.jpg')";
}
function getData(page,type){
	...
	$("#data").html("<img style='padding: 80px 0px 0px 80px;' src='static/images/loading.gif' alt='Loading please wait...'/>");
	if(type== "menu"){
	var y = document.getElementById(page);
        y.style.backgroundColor = "#75CE00";
		y.style.fontWeight = "bold";
		var posting =$.get("base/"+page+"/");
		}
	else
	...
	posting.done(function(data){
		if(data.substring(0,page.length)==page)
		$("#data").html(data.substring(page.length));
	});
